  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Alpine DEX Collectibles')}
      </Heading>
      <Text as="p">
        {t('Alpine DEX Collectibles are special ERC-721 NFTs that can be used on the Alpine DEX platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Alpine DEX Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Alpine DEX Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
