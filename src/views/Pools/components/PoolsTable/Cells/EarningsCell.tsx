...
const EarningsCell: React.FC<EarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  // These will be reassigned later if its Auto ADEX vault
  ...
  const labelText = isAutoVault ? t('Recent ADEX profit') : t('%asset% Earned', { asset: earningToken.symbol })
